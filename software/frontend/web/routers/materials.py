...
from software.backend.models.database_models import Project, User, Material, ProjectMaterial, MaterialUsage
from software.backend.auth.dependencies import get_current_user
from software.backend.schemas.material_schemas import (
    MaterialCreate,
    MaterialUpdate,
    MaterialResponse,
    ProjectMaterialAdd,
